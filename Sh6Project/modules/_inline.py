     ...
     if event.query.user_id == user.id and query.startswith( 
         ...
         result = builder.article( 
             ...
             thumb=InputWebDocument( 
                 ...
                 "image/jpeg", 
                 []), 
             text="**Pyrosupra-Userbot**\n➖➖➖➖➖➖➖➖➖➖\n✧  **ʀᴇᴘᴏ :** [Sh6Kuro](https://t.me/cmrkuro)\n✧ **sᴜᴘᴘᴏʀᴛ :** @cemarasupport\n✧ **ʀᴇᴘᴏsɪᴛᴏʀʏ :** [PyroSupra-Userbot](https://github.com/Sh6Kuro/PyroSupra-Userbot)\n➖➖➖➖➖➖➖➖➖➖", 
             buttons=[ 
                 [ 
                     custom.Button.url( 
                         "ɢʀᴏᴜᴘ", 
                         "https://t.me/cemarasupport"), 
                     custom.Button.url( 
                         "ʀᴇᴘᴏ", 
                         "https://github.com/Sh6Kuro/PyroSupra-Userbot"), 
                 ], 
             ], 
             link_preview=False, 
         ) 
         ...
         result = builder.article( 
             title="✨ PyroSupra-Userbot ✨", 
             description="PyroSupra - Userbot | Telethon", 
             url="https://t.me/Kat4logXcode", 
             thumb=InputWebDocument( 
                 var.INLINE_PIC, 
                 0, 
                 "image/jpeg", 
                 []), 
             text=f"**PyroSupra-Userbot**\n➖➖➖➖➖➖➖➖➖➖\n✧ **ᴏᴡɴᴇʀ :** [{user.first_name}](tg://user?id={user.id})\n✧ **ᴀssɪsᴛᴀɴᴛ:** {var.BOT_USERNAME}\n➖➖➖➖➖➖➖➖➖➖\n**ᴜᴘᴅᴀᴛᴇs :** @AyiinChannel\n➖➖➖➖➖➖➖➖➖➖", 
             buttons=[ 
                 [ 
                     custom.Button.url( 
                         "ɢʀᴏᴜᴘ", 
