...
from Sh6Project.helpers.misc import HAPP, XCB
from Sh6Project.helpers.tools import get_arg
from Sh6Project.utils.misc import restart
from Sh6Project.utils.pastebin import PasteBin
from Sh6Project.utils.tools import bash
...
async def upstream(client: Client, message: Message):
    ...
    if HEROKU_API_KEY is not None:
        ...
        if heroku_app is None:
            ...
            return
        await status.edit(
            "`[HEROKU]: Update Deploy PyroSupra-Userbot Sedang Dalam Proses...`"
        )
        ups_rem.fetch(ac_br)
        ...
        try:
            ...
            pass
        await status.edit(
            "`PyroSupra-Userbot Berhasil Diupdate! Userbot bisa di Gunakan Lagi.`"
        )
    else:
        try:
            ups_rem.pull(ac_br)
        ...
        args = [sys.executable, "-m", "Sh6Project"]
