...
from Sh6Project.helpers.parser import mention_html, mention_markdown
from Sh6Project.modules.help import *
...
async def kickdel_cmd(client: Client, message: Message):
    Sh6 = await edit_or_reply(message, "<b>Kicking deleted accounts...</b>")
    ...
    await Sh6.edit(f"<b>Successfully kicked {len(values)} deleted account(s)</b>")
